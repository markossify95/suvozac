    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('S', 'Service'), ('D', 'Driver')], default='D', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geo_lat', models.DecimalField(decimal_places=6, max_digits=8)),
                ('geo_long', models.DecimalField(decimal_places=6, max_digits=8)),
            ],
        ),
        migrations.CreateModel(
            name='ServiceMFType',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mf_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.MalfunctionType')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('C', 'Car'), ('T', 'Truck')], default='C', max_length=2)),
